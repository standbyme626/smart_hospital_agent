...
class DiagnosisState(TypedDict):
    ...
    query_rewrite_timeout_override_s: Optional[float]
    crisis_fastlane_override: Optional[bool]
    runtime_config_requested: Optional[Dict[str, Any]]
    runtime_config_effective: Optional[Dict[str, Any]]
    ...
    department_top1: Optional[str]
    department_top3: Optional[List[str]]
